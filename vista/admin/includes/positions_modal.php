            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="positions_add.php">
                <div class="form-group">
                    <label for="description" class="col-sm-3 control-label">Nombre del cargo</label>
                ...
                <div class="form-group">
                    <label for="max_vote" class="col-sm-3 control-label">Cantidad de candidatos a seleccionar</label>
